...
if __name__ == "__main__":
    # sma = "(Cl[c:6]([cH:3])[n:4].OB(O)[c:2]([cH:1])[cH:5])>>[cH:1][c:2]([cH:5])-[c:6]([cH:3])[n:4]"
    # temp = AllChem.ReactionFromSmarts(sma)
    # print(AllChem.ReactionToSmiles(TemplateExtractor.canon_rxn_template(temp)))
    ...
    smi1 = "Cl[c:15]1[n:14][c:13]([Cl:12])[cH:18][cH:17][cH:16]1.OB(O)[c:5]1[cH:4][c:3]([O:2][CH3:1])[cH:8][cH:7][cH:6]1>>[CH3:1][O:2][c:3]1[cH:4][c:5](-[c:15]2[n:14][c:13]([Cl:12])[cH:18][cH:17][cH:16]2)[cH:6][cH:7][cH:8]1"
    smi2 = "Cl[c:10]1[n:11][o:12][c:13]2[c:14]1[cH:15][c:16]([CH:28]=[O:29])[c:17]([N:20]1[CH2:21][C@@H:22]([CH3:27])[O:23][C@@H:24]([CH3:26])[CH2:25]1)[c:18]2[F:19].OB(O)[c:4]1[cH:3][n:2][nH:1][cH:5]1>>[nH:1]1[n:2][cH:3][c:4](-[c:10]2[n:11][o:12][c:13]3[c:14]2[cH:15][c:16]([CH:28]=[O:29])[c:17]([N:20]2[CH2:21][C@@H:22]([CH3:27])[O:23][C@@H:24]([CH3:26])[CH2:25]2)[c:18]3[F:19])[cH:5]1"
    smi3 = "Cl[c:2]1[cH:3][c:4]([NH:18][c:19]2[n:20][cH:21][cH:22][n:23][cH:24]2)[n:5][c:6]([NH:8][C@@H:9]([CH3:10])[c:11]2[cH:12][cH:13][c:14]([F:17])[cH:15][cH:16]2)[n:7]1.OB(O)[c:32]1[cH:31][cH:30][c:29]([S:26]([CH3:25])(=[O:27])=[O:28])[cH:34][cH:33]1>>[c:2]1(-[c:32]2[cH:31][cH:30][c:29]([S:26]([CH3:25])(=[O:27])=[O:28])[cH:34][cH:33]2)[cH:3][c:4]([NH:18][c:19]2[n:20][cH:21][cH:22][n:23][cH:24]2)[n:5][c:6]([NH:8][C@@H:9]([CH3:10])[c:11]2[cH:12][cH:13][c:14]([F:17])[cH:15][cH:16]2)[n:7]1"
    print(TemplateExtractor.rxn_smiles_to_rxn_temp_smarts(smi1, RxnTemplateType.EXTENDED, True))
    # print(TemplateExtractor.rxn_smiles_to_rxn_temp_smarts(smi2, RxnTemplateType.EXTENDED, True))
    print(TemplateExtractor.rxn_smiles_to_rxn_temp_smarts(smi3, RxnTemplateType.EXTENDED, True))
